...
Modules are the largest constructs in Knot, they can contain multiple [declarations](declaration) such as
[functionas](declaration/function) and [views](declaration/view). Modules can [import and export](module/import-export) entities
...
These include simple primitives like [booleans](primitive/boolean) and [integers](primitive/number#integer) as well as
